...
module.exports = function () {
  ...
  require(config.routesFile + 'user.server.routers.js')(app);
  require(config.routesFile + 'task.server.routers.js')(app);
  require(config.routesFile + 'indexMatriz.server.routers.js')(app);
